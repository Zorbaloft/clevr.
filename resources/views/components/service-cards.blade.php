                    ...
                    <div class="col-4 col-md-4 p-0">
                        <div class="card border-0 bg-transparent">
                            <div class="card-body text-center p-5">
                                <i class="fs-1 bi bi-basket"></i>
                                <h4 class="fw-bold text-uppercase mb-4">Vídeo Aulas</h4>
                                <p class="mb-4 ">Com o objetivo em mente de ajudar a nossa comunidade portuguesa este
                                    site foi desenvolvido com o objetivo de apresentar apenas aulas em português.</p>

                            </div>
                        </div>
                    </div>
                    <div class="col-4 col-md-4 p-0 border-top border-bottom border-start border-end">
                        <div class="card border-0 bg-transparent">
                            <div class="card-body text-center p-5">
...
>>>>>>> 0a4dcae14fae8d74d1e1752f9367d63a0594eb1f
                    ...
                    <div class="col-4 col-md-4 p-0">
                        <div class="card border-0 bg-transparent">
                            <div class="card-body text-center p-5">
                                <i class="fs-1 bi bi-incognito"></i>
