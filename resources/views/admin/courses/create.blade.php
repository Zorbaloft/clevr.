    ...
    <x-slot name="header">
        ...
        <form method="post" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <input id="excerpt" name="excerpt" type="text" class="form-control" required autocomplete="excerpt"
                   />
                <x-input-error class="mt-2" :messages="$errors->get('excerpt')" />
            </div>
            <div class="form-group">
                <label for="imagePath" class="form-label">{{ __('Image Path:') }}</label>
            ...
            <div class="form-group">
                <label for="access" class="form-label">{{ __('Access Time') }}</label>
