<template>
    <v-footer class="text-center d-flex flex-column mt-auto" color="brown-darken-4" absolute app>
        <div>
        ...
        <div class="pt-2">
            ...
            dui. Duis commodo vitae velit et faucibus. Morbi vehicula lacinia malesuada. .
        </div>
